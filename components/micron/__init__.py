    ...
    cv.Schema(
        {
            ...
            cv.Required(CONF_CLOCK2_PIN): cv.All(pins.internal_gpio_input_pin_schema),
...
async def to_code(config):
    ...
    pin_clock2 = await gpio_pin_expression(config[CONF_CLOCK2_PIN])
    cg.add(var.set_pin_clock2(pin_clock2))
